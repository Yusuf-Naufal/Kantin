<x-karyawan-layout :title="$title">
                    ...
                    <div class="order-card bg-white rounded-lg shadow-md border border-gray-200 p-4 mb-4 relative">
                        <div class="order-item flex justify-between items-start">
                            ...
                            <div class="flex flex-col space-y-1">
                                ...
                                <button onclick="Konfirmasi({{ $order->id }}, 'Rejected')" class="px-3 py-1 text-xs bg-red-500 text-white rounded-md hover:bg-red-600">
                                    Reject
                                </button>
                                    ...
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="w-full max-w-xl overflow-y-auto" style="max-height: 500px;">
                                                    ...
                                                    <div class="w-full rounded-lg bg-white dark:bg-gray-800 shadow-lg py-3 px-4 mb-6 border border-gray-200 dark:border-gray-700">
                                                        ...
                                                        @else
                                                            ...
                                                            <div id="map{{ $order->id }}" class="w-full h-72 rounded-lg z-0"></div>
                                                            <div>
                                                                <!-- Address Display -->
                                                                <div class="text-gray-700 dark:text-gray-300 font-sans font-light mb-4">
                                                                    ...
                                                                    <span class="text-lg font-bold mt-2">Alamat:</span>
                                            ...
                                            <div class="flex items-center justify-end p-4 border-t border-gray-200 dark:border-gray-600 gap-2">
                                                <button id="reject-button" type="button" class="px-3 py-2 text-sm bg-red-500 text-white rounded-md hover:bg-red-600">
                                                    Reject
                                                </button>
                                                <button id="accept-button" type="button" class="px-3 py-2 text-sm bg-green-500 text-white rounded-md hover:bg-green-600">
                                                    Accept
                                                </button>
                                            </div>
                                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const acceptOrder = document.getElementById('accept-button');
            const rejectOrder = document.getElementById('reject-button');
            ...
            function updateOrderStatus(status) {
                ...
                Swal.fire({
                    title: 'Mohon tunggu...',
                    text: 'Proses update sedang berlangsung',
            ...
            acceptOrder.addEventListener('click', () => showConfirmationDialog('Process'));
            rejectOrder.addEventListener('click', () => showConfirmationDialog('Rejected'));
        });
