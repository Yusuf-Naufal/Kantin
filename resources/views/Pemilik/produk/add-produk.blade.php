<x-master-layout :title="$title"> 
    <div class="w-full p-2">
        ...
        <form id="outlet-form" action="{{ route('pemilik-store-produk') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Card Container -->
                    ...
                    <div class="flex w-full gap-4 flex-col lg:flex-row items-center">
                        ...
                        <div class="w-full">
                            ...
                            <div class="mb-4 w-full">
                                ...
                                <input class="hidden" type="text" value="{{ $user->id_outlet }}" name="id_outlet" id="">
                            ...
                            <div class="flex gap-4">
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="sku" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="sku" placeholder="Generate Otomatis / Scan code" readonly>
                                </div>
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <div class="flex w-full pr-7 gap-3 mt-4 flex-col lg:flex-row">
                        <div class="w-full md:w-1/2 mb-4">
                            ...
                            <input type="text" id="stok" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="stok">
                        </div>
                        <div class="w-full md:w-1/2 mb-4">
                            <label class="block text-sm font-medium text-gray-700" for="stok_minimum">Stok Minimum</label>
                            <input type="text" id="stok_minimum" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="stok_minimum">
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 mb-4 pr-7">
                        <label class="block text-sm font-medium text-gray-700" for="harga_jual">Harga Jual</label>
                        <input type="text" id="harga_jual" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="harga_jual">
                    </div>
                    <div class="w-full md:w-1/2 mb-4 pr-7">
                        <label class="block text-sm font-medium text-gray-700" for="harga_modal">Harga Modal</label>
                        <input type="text" id="harga_modal" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="harga_modal">
                    </div>
                </div>
                <div class="w-full md:w-1/2">
                    ...
                    <div class="w-full flex flex-col md:flex-row gap-2 items-center">
                        ...
                        <div class="w-full mt-4" id="diskon-harga" style="display: none;">
                            ...
                            <input type="number" id="harga-diskon" pattern="[0-9]*" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="harga_diskon" readonly>
                        </div>
                    </div>
            ...
            <div class="bg-white h-auto w-full shadow-md rounded-lg p-2 mt-4">
                ...
                <textarea id="wysiwyg-editor" name="deskripsi" style="height: 240px;" class="w-full h-60 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" ></textarea>
            </div>

            <!-- Button Container -->
            <div class="w-full flex justify-end mt-4">
                <div>
                    <a href="{{ route('pemilik-produk') }}" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                        Batal
                    </a>
                    <button id="tambah-button" type="submit" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        Tambah
                    </button>
                </div>
            </div>
        ...
        <div id="kategori-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <form action="{{ route('pemilik-store-kategori') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    <!-- Modal content -->
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <!-- Modal header -->
