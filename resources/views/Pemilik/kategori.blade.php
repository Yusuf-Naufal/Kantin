<x-master-layout :title="$title">
    <div class="w-full">
        <div class="flex justify-between flex-col md:flex-row mt-2 gap-3">
            <h1 class="text-3xl font-bold">Kategori : Produk {{ $user->Outlet->nama_outlet }}</h1>
        </div>
        ...
        <div class="flex justify-between flex-col md:flex-row items-center mt-2">
            ...
            <div class="flex flex-col md:flex-row gap-3 items-start w-full md:w-auto mt-2">
                <div class="flex flex-col md:flex-row w-full">
                    <form method="GET" action="{{ route('pemilik-kategori') }}" class="flex items-center flex-col md:flex-row w-full gap-2">
                        <!-- Hidden Inputs -->
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="simple-search" onkeyup="searchTable()" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 transition duration-150 ease-in-out mb-1" placeholder="Search Kategori..." required />
                </div>
            </div>
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <form action="{{ route('destroy-kategori', $kategori->id) }}" method="POST">
                                    ...
                                    <div class="p-4 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-gray-500">Apakah anda yakin akan menghapus kategori <b>{{ $kategori->nama_kategori }}</b>? Produk dengan kategori {{ $kategori->nama_kategori }} akan dihapus!!</h3>
