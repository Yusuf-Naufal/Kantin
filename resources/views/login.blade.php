...
<body class="flex items-center justify-center h-screen p-3" style="background: whitesmoke">
    
    <div class="container shadow-lg rounded-lg bg-white max-w-md p-6">
        <form class="max-w-lg mx-auto m-0" action="{{ route('login.submit') }}" method="POST">
            @csrf
            <h1 class="text-center font-bold text-4xl mb-4">Login</h1>
            <div class="mb-5">
            ...
            <div class="flex justify-between items-center mb-5">
                ...
                <div>
                    <a href="{{ route('lupa-form') }}" class="text-blue-400 font-sans text-sm">Lupa Password?</a>
                </div>
            </div>
            <div class="w-full">
                <button style="width: 100%" type="submit" class="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
                <div class="w-full flex items-center justify-center mt-2">
                    <a href="{{ route('register-form') }}" class="text-blue-400 font-sans text-sm text-center">Belum Punya Akun?</a>
                </div>
            </div>
        ...
        <div class="inline-flex items-center justify-center w-full">
            ...
            <div class="absolute px-4 -translate-x-1/2 bg-white left-1/2 dark:bg-gray-900">
                <h1 class="text-base font-semibold">OR</h1>
            </div>
        </div>

        <form action="{{ route('login.google') }}" class="rounded-lg border border-blue-500" style="margin: auto;margin-bottom: 10px">
            @csrf
            <button type="submit" class="flex items-center justify-center w-full text-blue-500 bg-white hover:bg-blue-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-4 transition duration-200 ease-in-out">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" class="mr-2 h-5 w-5">
