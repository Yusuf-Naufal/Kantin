<x-admin-layout :title="$title">
    <div class="w-full p-2">
        ...
        <div class="bg-white h-auto w-full shadow-md rounded-lg p-2">
            <form id="outlet-form" action="{{ route('admin-store-outlet') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="flex flex-wrap gap-4">
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex gap-4 flex-col lg:flex-row ">
                                ...
                                <div class="w-full md:w-1/3 mb-4">
                                    ...
                                    <select name="pemilik" id="id_label_single" style="height: 41px;" class="js-example-basic-single js-states form-control mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                    ...
                    <div class="mb-4 w-full">
                        ...
                        <input type="text" id="alamat" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="alamat" required>
                    </div>
                    ...
                    <div class="w-full flex justify-end">
                        <div>
                            <a href="{{ route('admin-all-outlet') }}" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                                Batal
                            </a>
                            <button id="tambah" type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                Tambah
                            </button>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.getElementById('tambah').addEventListener('click', function (event) {
            ...
            const pinInput = document.getElementById('pin').value;
             const fotoInput = document.getElementById('dropzone-file'); 
            const emailPattern = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
            ...
            if (fotoInput.files.length === 0) {
                Swal.fire({
                    icon: 'warning',
                    title: 'Foto kosong!',
                    text: 'Mohon masukkan foto outlet anda!',
                    confirmButtonColor: '#3085d6',
                });
                return;
            }
