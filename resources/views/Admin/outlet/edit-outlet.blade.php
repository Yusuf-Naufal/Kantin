                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-center w-64 h-64">
                                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                    ...
                                    <img class="w-full h-full rounded-md" id="image-update" src="{{ Storage::url('app/public/assets/' . $outlet->foto) }}" alt="">
                                </label>
                            </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex gap-4 flex-col lg:flex-row ">
                                ...
                                <div class="w-full md:w-1/3 mb-4">
                                    ...
                                    <select name="pemilik" id="id_label_single" style="height: 41px;" class="js-example-basic-single js-states form-control mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                        <option value="" selected disabled>Pilih Pemilik</option>
                                        @foreach ($users as $user)
                                            <option value="{{ $user->name }}" {{ old('pemilik') == $user->name ? 'selected' : '' }}>
                                                {{ $user->name }}
                                            </option>
                                        @endforeach
                                    </select>
