<x-admin-layout :title="$title">
    ...
    {{-- <div class="flex items-center justify-between mt-4 px-2">
        <div class="text-gray-700">
            Showing <span class="font-semibold">{{ $unit->firstItem() }}</span> to 
            <span class="font-semibold">{{ $unit->lastItem() }}</span> of 
            <span class="font-semibold">{{ $unit->total() }}</span> results
        </div>
        <div>
            {{ $unit->links('vendor.pagination.tailwind') }}
        </div>
    </div> --}}
