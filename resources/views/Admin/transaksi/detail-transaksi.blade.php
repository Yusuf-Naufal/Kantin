    ...
    <div class="w-full p-2" id="detail-transaksi">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-center mb-6 p-4 bg-white shadow rounded-lg">
            ...
            <div class="flex flex-wrap gap-2 mt-4 lg:mt-0">
                ...
                <a href="{{ route('admin-edit-transaksi', $transaksi->resi) }}" class="bg-purple-700 text-white hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 transition duration-200 ease-in-out">
                    Ubah
                </a>
                ...
                <div id="dropdownDots" class="hidden z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                        ...
                        <li>
                            <a href="{{ route('admin-transaksi') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Kembali</a>
                        </li>
                    </ul>
                </div>
            </div>
